...
if user=="" or password=="":
    ...
    if RecordSet==False:
        print "Server was contacted but there was a problem either with your login details, or GPIO setup"
        print "Check you user and password details, and check you have configured a GPIO seeting at www.privateeyepi.com"
    else:
